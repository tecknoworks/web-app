...
export class TvShowService {
  ...
  public mockData(): Array<TvShow> {
    ...
    return [
      ...
      new TvShow('2', "Money Heist 2", new Actor("1", "john tom"), "A lot of action", new Date("7/7/2017"), 3, new Genre('2', "Drama"), new ContentRating('1', "PG-15","ceva"), 8.5, [new Actor('1', "john loft"), new Actor('2', "john tiom")], "assets/images/eg1.jpg", "https://www.youtube.com/embed/hMANIarjT50",
        seasonMap
      ),
      new TvShow('3', "Money Heist 3", new Actor("1", "john tom"), "A lot of action", new Date("7/7/2017"), 3, new Genre('3', "Thriller"), new ContentRating('1', "PG-15","ceva"), 8.5, [new Actor('1', "john loft"), new Actor('2', "john tiom")], "assets/images/eg1.jpg", "https://www.youtube.com/embed/hMANIarjT50",
        seasonMap
      ),
      new TvShow('4', "Money Heist 4", new Actor("1", "john tom"), "A lot of action", new Date("7/7/2017"), 3, new Genre('4', "Comedy"), new ContentRating('1', "PG-15","ceva"), 8.5, [new Actor('1', "john loft"), new Actor('2', "john tiom")], "assets/images/eg1.jpg", "https://www.youtube.com/embed/hMANIarjT50",
        seasonMap
      ),
      new TvShow('5', "Money Heist 5", new Actor("1", "john tom"), "A lot of action", new Date("7/7/2017"), 3, new Genre('1', "Action"), new ContentRating('1', "PG-15","ceva"), 8.5, [new Actor('1', "john loft"), new Actor('2', "john tiom")], "assets/images/eg1.jpg", "https://www.youtube.com/embed/hMANIarjT50",
        seasonMap
      ),
      new TvShow('6', "Money Heist 6", new Actor("1", "john tom"), "A lot of action", new Date("7/7/2017"), 3, new Genre('2', "Drama"), new ContentRating('1', "PG-15","ceva"), 8.5, [new Actor('1', "john loft"), new Actor('2', "john tiom")], "assets/images/eg1.jpg", "https://www.youtube.com/embed/hMANIarjT50",
        seasonMap
      ),
    ];
  }
